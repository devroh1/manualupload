...
var ConnectionStateMonitor = /** @class */ (function () {
    ...
    ConnectionStateMonitor.prototype.enableNetworkMonitoring = function () {
        ...
        if (this._networkMonitoringSubscription === undefined) {
            this._networkMonitoringSubscription = new core_1.Reachability()
                .networkMonitor()
    ...
    ConnectionStateMonitor.prototype.connectionStatesTranslator = function (_a) {
        ...
        if (connectionState === 'connected' && networkState === 'disconnected')
            return index_1.ConnectionState.ConnectedPendingNetwork;
        if (connectionState === 'connected' &&
            intendedConnectionState === 'disconnected')
            return index_1.ConnectionState.ConnectedPendingDisconnect;
        if (connectionState === 'disconnected' &&
            intendedConnectionState === 'connected' &&
            networkState === 'disconnected')
            return index_1.ConnectionState.ConnectionDisruptedPendingNetwork;
        if (connectionState === 'disconnected' &&
            intendedConnectionState === 'connected')
            return index_1.ConnectionState.ConnectionDisrupted;
        if (connectionState === 'connected' && keepAliveState === 'unhealthy')
            return index_1.ConnectionState.ConnectedPendingKeepAlive;
        // All remaining states directly correspond to the connection state
        if (connectionState === 'connecting')
            return index_1.ConnectionState.Connecting;
        if (connectionState === 'disconnected')
            return index_1.ConnectionState.Disconnected;
        return index_1.ConnectionState.Connected;
    };
